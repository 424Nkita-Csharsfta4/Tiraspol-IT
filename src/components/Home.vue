    ...
    <div class="grid grid-flow-row-dense grid-cols-1 lg:grid-cols-2 items-end gap-10 lg:gap-16 w-full px-0 lg:px-10">
      <div class="text-5xl md:text-6xl font-bold text-white w-full pb-20 order-2 lg:order-1">
        <div class="flex items-center gap-3">
          <h2>Самые популярные ЯП в Тирасполе</h2>
          <img width="220px" height="220px" src="https://media2.giphy.com/media/f7omQNmgiyjj5sffvZ/giphy.gif?cid=ecf05e47gqnv5vvia1vn19v02qpbr03jjmwu1czloxs9zjnj&rid=giphy.gif&ct=s" alt="head1-img">
        </div>
        <h2 class="text-4xl md:text-5xl"></h2>
        <p class="pt-5 text-lg font-normal"></p>
      </div>
